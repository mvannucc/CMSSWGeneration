...
config.JobType.scriptArgs  = ['nEvents=1500','nThreads=4','outputName=miniaodStep.root','mxmin=1000','mxmax=1500','mymin=90','mymax=150','nGridpacksPerJob=10','inputGridpacks=/store/user/rgerosa/NMSSM_XToYH_gridpacks']
...
config.Data.outputPrimaryDataset = 'NMSSM_XToHY_HTo2B_YTo2Tau_MX_1000_1500_MY_90_150_TuneCP5_madgraph-pythia8_13TeV'
