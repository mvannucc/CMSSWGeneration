...
config.JobType.scriptArgs  = ['nEvents=1000','nThreads=4','outputName=miniaodStep.root','mxmin=2000','mxmax=2500','mymin=90','mymax=150','nGridpacksPerJob=10','/store/user/rgerosa/NMSSM_XToYH_gridpacks']
