...
## General settings
config.General.requestName = 'rgerosa_test'
...
config.JobType.scriptArgs  = ['nEvents=1000','nThreads=4','outputName=miniaodStep.root','mxmin=1000','mxmax=1500','mymin=90','mymax=150','nGridpacksPerJob=10','path=/store/user/rgerosa/NMSSM_XToYH_gridpacks']
...
config.Data.outLFNDirBase = '/store/group/phys_exotica/monojet/rgerosa/HH_test'
config.Data.publication   = False
config.Data.outputPrimaryDataset = 'NMSSM_XToYHTo2B2Tau_TuneCP5_madgraph-pythia8_13TeV_test'
