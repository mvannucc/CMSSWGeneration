...
## General settings
config.General.requestName = 'rgerosa_NMSSM_XToYH_HTo2B_YTo2Tau_mX_1500_2000'
...
config.JobType.scriptArgs  = ['nEvents=1500','nThreads=4','outputName=miniaodStep.root','mxmin=1500','mxmax=2000','mymin=75','mymax=175','nGridpacksPerJob=15','inputGridpacks=/store/user/rgerosa/NMSSM_XToYH_gridpacks']
...
config.Data.outputPrimaryDataset = 'NMSSM_XToHY_HTo2B_YTo2Tau_MX_1500_2000_MY_75_175_TuneCP5_madgraph-pythia8_13TeV'
