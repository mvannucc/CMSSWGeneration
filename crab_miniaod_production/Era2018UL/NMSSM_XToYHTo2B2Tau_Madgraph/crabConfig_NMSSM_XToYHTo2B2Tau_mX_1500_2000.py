...
## General settings
config.General.requestName = 'rgerosa_NMSSM_XToYHTo2B2Tau_mX_1500_2000'
...
config.JobType.scriptArgs  = ['nEvents=1000','nThreads=4','outputName=miniaodStep.root','mxmin=1500','mxmax=2000','mymin=90','mymax=150','nGridpacksPerJob=10','inputGridpacks=/store/user/rgerosa/NMSSM_XToYH_gridpacks']
...
config.Data.outputPrimaryDataset = 'NMSSM_XToYHTo2B2Tau_MX_1500_2000_MY_90_150_TuneCP5_madgraph-pythia8_13TeV'
