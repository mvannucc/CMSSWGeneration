...
config.JobType.scriptArgs  = ['nEvents=1000','nThreads=4','outputName=miniaodStep.root','mxmin=1500','mxmax=2000','mymin=90','mymax=150','nGridpacksPerJob=10','/store/user/rgerosa/NMSSM_XToYH_gridpacks']
