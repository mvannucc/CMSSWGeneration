...
## General settings
config.General.requestName     = 'rgerosa_ggHtt_pt_100_250'
...
config.JobType.scriptArgs  = ['nEvents=1500','nThreads=4','outputName=miniaodStep.root','higgsPtMin=100','higgsPtMax=250','higgsMassMin=80','higgsMassMax=160','higgsMassStepSize=2','nMassesPerJob=10']
...
config.Data.outputPrimaryDataset = 'GluGluHToTauTau_PtH_100to250_mH_80to160_TuneCP5_pythia8_13TeV'
