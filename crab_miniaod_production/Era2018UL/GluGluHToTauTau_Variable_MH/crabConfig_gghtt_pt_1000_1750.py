...
## General settings
config.General.requestName     = 'rgerosa_ggHtt_pt_1000_1750'
...
config.JobType.scriptArgs  = ['nEvents=1500','nThreads=4','outputName=miniaodStep.root','higgsPtMin=1000','higgsPtMax=1750','higgsMassMin=80','higgsMassMax=160','higgsMassStepSize=2','nMassesPerJob=10']
...
config.Data.outputPrimaryDataset = 'GluGluHToTauTau_PtH_1000to1750_mH_80to160_TuneCP5_pythia8_13TeV'
