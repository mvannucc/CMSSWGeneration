...
## General settings
config.General.requestName     = 'rgerosa_ggHtt_pt_0_100'
...
config.JobType.scriptExe   = 'scriptExe_gghtt.sh'
config.JobType.scriptArgs  = ['nEvents=1500','nThreads=4','outputName=miniaodStep.root','higgsPtMin=0','higgsPtMax=100','higgsMassMin=80','higgsMassMax=160','higgsMassStepSize=2','nMassesPerJob=10']
config.JobType.inputFiles  = ['scriptExe_gghtt.sh', 'gen_step_gghtt.py','sim_step.py','digi_raw_step.py','hlt_step.py','reco_step.py','miniaod_step.py','../pileup.py']
...
config.Data.outputPrimaryDataset = 'GluGluHToTauTau_PtH_0to100_mH_80to160_TuneCP5_pythia8_13TeV'
