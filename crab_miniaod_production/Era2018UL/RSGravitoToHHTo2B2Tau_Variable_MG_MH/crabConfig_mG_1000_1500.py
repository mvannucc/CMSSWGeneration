...
## General settings
config.General.requestName     = 'rgerosa_mG_1000_1500'
...
config.JobType.scriptArgs  = ['nEvents=1000','nThreads=4','outputName=miniaodStep.root','resonanceMassMin=1000','resonanceMassMax=1500','resonanceMassStepSize=50','higgsMassMin=90','higgsMassMax=150','higgsMassStepSize=2','nMassesPerJob=10']
...
config.Data.outputPrimaryDataset = 'RSGravitonToHHToTo2B2Tau_mG_1000to1500_mH_90to150_TuneCP5_pythia8_13TeV'
