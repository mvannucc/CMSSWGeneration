...
config.JobType.scriptArgs  = ['nEvents=1500','nThreads=4','outputName=miniaodStep.root','resonanceMassMin=1000','resonanceMassMax=1500','resonanceMassStepSize=50','higgsMassMin=80','higgsMassMax=160','higgsMassStepSize=5','nMassesPerJob=10']
...
config.Data.outputPrimaryDataset = 'RSGravitonToHHToTo2B2Tau_mG_1000to1500_mH_80to160_TuneCP5_pythia8_13TeV'
