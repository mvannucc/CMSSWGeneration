...
config.JobType.scriptArgs  = ['nEvents=1000','nThreads=4','outputName=miniaodStep.root','resonanceMassMin=2000','resonanceMassMax=2500','resonanceMassStepSize=50','higgsMassMin=90','higgsMassMax=150','higgsMassStepSize=2','nMassesPerJob=10']
...
config.Data.outputPrimaryDataset = 'RSGravitonToHHToTo2B2Tau_mG_2000to2500_mH_90to150_TuneCP5_pythia8_13TeV'
