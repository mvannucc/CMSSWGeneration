...
config.JobType.scriptArgs  = ['nEvents=1500','nThreads=4','outputName=miniaodStep.root','resonanceMassMin=350','resonanceMassMax=650','resonanceMassStepSize=50','higgsMassMin=80','higgsMassMax=160','higgsMassStepSize=5','nMassesPerJob=10']
...
config.Data.outputPrimaryDataset = 'RSGravitonToHHToTo2B2Tau_mG_350to650_mH_80to160_TuneCP5_pythia8_13TeV'
