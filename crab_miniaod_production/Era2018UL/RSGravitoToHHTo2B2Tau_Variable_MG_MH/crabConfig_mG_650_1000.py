...
config.JobType.scriptArgs  = ['nEvents=1500','nThreads=4','outputName=miniaodStep.root','resonanceMassMin=650','resonanceMassMax=1000','resonanceMassStepSize=50','higgsMassMin=80','higgsMassMax=160','higgsMassStepSize=5','nMassesPerJob=10']
...
config.Data.outputPrimaryDataset = 'RSGravitonToHHToTo2B2Tau_mG_650to1000_mH_80to160_TuneCP5_pythia8_13TeV'
