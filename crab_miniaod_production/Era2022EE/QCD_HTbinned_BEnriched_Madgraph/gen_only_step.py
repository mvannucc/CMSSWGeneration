...
# with command line options: Configuration/GenProduction/python/EGM-Run3Summer22EEwmLHEGS-00001-fragment.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:EGM-Run3Summer22EEwmLHEGS-00001.root --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int() --step LHE,GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n 100
...
options.register('gridpack', '', VarParsing.multiplicity.singleton,VarParsing.varType.string,"gridpack")
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:'+options.outputName.replace(".root","_inLHE.root")),
