...
## General settings
config.General.requestName = 'rgerosa_QCD_bEnriched_2jet_HT_350_500'
...
config.JobType.scriptArgs  = ['nEvents=1500','nThreads=4','outputName=miniaodStep.root','gridpack=./QCD_bEnriched_2jet_HT_350_500_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz']
config.JobType.inputFiles  = ['scriptExe.sh','gen_sim_step.py','digi_raw_step_hlt.py','reco_step.py','miniaod_step.py','../pileup.py','/eos/cms/store/user/rgerosa/QCD_HTbinned_BEnriched_gridpacks/QCD_bEnriched_2jet_HT_350_500_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz']
...
config.Data.outputPrimaryDataset = 'QCD_bEnriched_2jet_HT_350_500_TuneCP5_madgraph-pythia8_13p6TeV'
