...
config.JobType.psetName = 'SMP-RunIISummer15wmLHEGS-00006_1_cfg_SM.py'
config.JobType.inputFiles = ['/eos/user/j/jixiao/eft/2016/SSWW_SMlimit_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz']
