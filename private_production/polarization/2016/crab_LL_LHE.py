...
config.JobType.psetName = 'SMP-RunIISummer15wmLHEGS-00006_1_cfg_LL.py'
config.JobType.inputFiles = ['/eos/user/j/jixiao/polar/2016/VBS_SSWW_LL_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz']
