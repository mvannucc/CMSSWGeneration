...
config.JobType.psetName = 'SMP-RunIISummer15wmLHEGS-00006_1_cfg_BSM.py'
config.JobType.inputFiles = ['/eos/user/j/jixiao/eft/2016/SSWW_RcW_bsm_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz']
