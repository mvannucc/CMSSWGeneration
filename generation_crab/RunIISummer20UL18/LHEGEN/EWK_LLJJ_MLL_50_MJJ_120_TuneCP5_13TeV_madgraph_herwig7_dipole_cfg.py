...
# modify shower variations
herwig7LHECommonSettingsBlock.hw_lhe_common_settings = [element if "PartnerFinder" in element else element.replace('Shower','DipoleShower') for element in herwig7LHECommonSettingsBlock.hw_lhe_common_settings]
herwig7CH3SettingsBlock.herwig7CH3PDF = [element.replace('Shower','DipoleShower') for element in herwig7CH3SettingsBlock.herwig7CH3PDF]
herwig7LHEMG5aMCatNLOSettingsBlock.hw_lhe_MG5aMCatNLO_settings = [ element if "KinematicsReconstructor" in element else element.replace('Shower','DipoleShower') for element in herwig7LHEMG5aMCatNLOSettingsBlock.hw_lhe_MG5aMCatNLO_settings]
