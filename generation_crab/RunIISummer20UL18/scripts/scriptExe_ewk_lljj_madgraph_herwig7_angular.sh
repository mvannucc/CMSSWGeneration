...
echo "cmsRun -e -j FrameworkJobReport.xml EWK_LLJJ_MLL_50_MJJ_120_TuneCP5_13TeV_madgraph_herwig7_angular_cfg.py jobNum="$1" "$2" "$3" outputName=lheGenStep_"$1".root"
cmsRun -e -j FrameworkJobReport.xml EWK_LLJJ_MLL_50_MJJ_120_TuneCP5_13TeV_madgraph_herwig7_angular_cfg.py jobNum=$1 $2 $3 outputName=lheGenStep"_"$1.root
